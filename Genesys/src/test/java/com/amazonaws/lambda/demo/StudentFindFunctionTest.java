...
import com.amazonaws.lambda.demo.Function.studentFindFunction;
...
public class studentFindFunctionTest {
    ...
    @Test
    public void teststudentFindFunction() {
        studentFindFunction handler = new studentFindFunction(s3Client);
